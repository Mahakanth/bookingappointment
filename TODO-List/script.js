function addlist(e){
    ...
    axios.post("https://crudcrud.com/api/c048e4e9620d44e2b1b7126673ac89fc" , obj)
        .then((response) => {
...
window.addEventListener("DOMContentLoaded" , () => {
    ...
    axios.get("https://crudcrud.com/api/c048e4e9620d44e2b1b7126673ac89fc/todolist")
        .then((response) => {
...
function deleteItem(objid){
    axios.delete(`https://crudcrud.com/api/c048e4e9620d44e2b1b7126673ac89fc/todoList/${objid}`)
        .then((response) => {
            removeFromWeb(objid);
        })
        .catch((err) => {
